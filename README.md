...
| `Mjlab-HeadSpin-Flat-MicroDuck` | flat | Plant the flat head top, yaw at least 180°, return to the feet |
...
| `robot_allcollisions.xml` | VelStand, StandUp, SitStand, GroundPick, BallKick, Roulade, HeadSpin (body can physically lie on the ground) |
